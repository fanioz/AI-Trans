...
class RoadPF
{
	 ...
	 * @param ignored_tiles Array of tiles to ignore during pathfinding
...
function RoadPF::InitializePath(sources, goals, max_length_multiplier = 0, max_length_offset = 10000, ignored_tiles = [])
{
	local nsources = [];
