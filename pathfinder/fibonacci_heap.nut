/* From AI Library : Queue.Fibonacci_Heap
/* $Id: main.nut 15092 2009-01-15 16:53:18Z truebrain $ */
/* Modified for AI-Trans */
...
class Fibonacci_Heap {
	...
	function Insert(item, priority) {
		/* Create a new node struct to add to the heap. */
		local node = {};
	 ...
	 */
	function Exists(item) { return ExistsIn(_root_list, item); }
